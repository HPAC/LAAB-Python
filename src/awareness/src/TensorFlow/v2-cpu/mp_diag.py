...
if __name__ == "__main__":
    ...
    for i in range(REPS):
        ...
        print("[LAAB] TensorFlow | mp_diag | optimized={:.5f} s | actual={:.5f} s | linalg_matmul={:.5f} s | linalg_tridiagonal_matmul={:.5f} s".format(elapsed_optimized, elapsed_actual, elapsed_matmul, elaposed_tridiagonal))  
